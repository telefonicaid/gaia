(function (self) {
  ...
  Offliner.prototype.standalone = function () {
    ...
    self.addEventListener('install', function (e) {
      e.waitUntil(
        this._install()
          .then(() => {
            this._sendInstallationDone();
            log('Offliner installed');
          }, this._sendInstallationFailed.bind(this))
      );
    }.bind(this));
  ...
  /**
   * Broadcast a message to all clients to indicate the installation ended
   * properly.
   *
   * @method _sendInstallationDone
   * @private
   */
  Offliner.prototype._sendInstallationDone = function () {
    this._broadcastMessage({ type: 'installationDone' });
  };

  /**
   * Broadcast a message to all clients to indicate the installation failed.
   *
   * @method _sendInstallationFailed
   * @private
   */
  Offliner.prototype._sendInstallationFailed = function () {
    this._broadcastMessage({ type: 'installationFailed' });
  };
